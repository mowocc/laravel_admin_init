<template>
    <el-dialog :title="$t('system.user.dialog.create')" width="460px" :visible.sync="dialogVisible" @close="$emit('update:visible', false)">
        <div class="pr-5">
            <el-form :model="dataCache" label-width="85px">
                ...
                <el-form-item :label="$t('system.user.dialog.password')" :error="Boolean(msg.errors['password']) ? msg.errors['password'][0] : ''" required>
                    <el-input v-model="dataCache.password" :placeholder="$t('system.user.dialog.passwordPlaceholder.create')"></el-input>
                </el-form-item>
                <el-form-item>
