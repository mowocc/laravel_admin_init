        ...
        'system' => [
            'setting' => [
                ...
                'server' => [
                    'store-update' => [
                        'attributes' => [
                            'mysql_agency.host' => '主机',
                            'mysql_agency.port' => '端口',
                            'mysql_agency.database' => '数据库',
                            'mysql_agency.username' => '用户名',
                            'mysql_agency.password' => '密码'
                        ]
                    ]
                ],
                'menu' => [
                ...
                'menu-action' => [
                    'store-update' => [
                        'attributes' => [
                            'actions.system.*.name' => '名称',
                            'actions.system.*.action' => 'Action',
                            'actions.custom.*.name' => '名称',
