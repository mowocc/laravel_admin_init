    ...
    */
    ...
    'connections' => [
        ...
        'mysql_admin' => [
            ...
            'database' => env('MYSQL_ADMIN_DATABASE', 'forge'),
            'username' => env('MYSQL_ADMIN_USERNAME', 'forge'),
        ...
        'mysql_agency' => [
            ...
            'database' => env('MYSQL_AGENCY_DATABASE', 'forge'),
            'username' => env('MYSQL_AGENCY_USERNAME', 'forge'),
